...
const CommentsWrapper: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    commentTypeRef.current = commentType;
  ...
  useEffect(() => {
    ...
    giscusContainer.className = "giscus-comments-container";
  ...
  if (displayMode === "guestbook") {
    return (
      <div className="not-prose">
        <div
          ref={containerRef}
          className="comments-wrapper guestbook-comments"
        ></div>
      </div>
    );
  }
  ...
  return (
    <div className="not-prose">
      <div ref={containerRef} className="comments-wrapper"></div>
    </div>
  );
};
